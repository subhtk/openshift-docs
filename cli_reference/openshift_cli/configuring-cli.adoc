...
//Accessing kubeconfig using oc CLI
[id="cli-accessing-kubeconfig-cli_{context}"]
== Accessing the `kubeconfig`

include::modules/cli-configuring-kubeconfig-oc-cli.adoc[leveloffset=+1]